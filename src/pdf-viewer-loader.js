...
(function () {
  ...
  const pageTitle = params.get('title') ? decodeURIComponent(params.get('title')) : decodedFilename;
  ...
  overlay.innerHTML =
    '<div class="gp-loading-box">' +
      ...
      '<div class="gp-loading-text">Loading ' + decodedFilename.replace(/</g, '&lt;') + '...</div>' +
    '</div>';
  ...
  (async () => {
    try {
      ...
      if (textEl) textEl.textContent = 'Failed to load PDF: ' + err.message;
    }
  })();
})();
